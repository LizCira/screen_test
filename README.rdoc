...
A team goal was to gain experience with Javascript and to keep as much our code client side. To that end, we use:

	 Chart.js -- Radar Chart data visualization
	 http://chartjs.org/
	 jQuery JavaScript Library v1.11.1
 	 http://jquery.com/
 	 jQuery UI - v1.10.4 - 2014-04-02 -- Drag and drop animation
	 http://jqueryui.com
...
FINISHG THIS WHEN WE WRITE COPY FOR THE APP

**About Us**

We're all students at General Assembly's New York City April 2014 WDI program. More about us: 
